...
import { BrowserRouter as Router, Route, Routes, Link } from 'react-router-dom'; // Importation de React Router
  ...
  const watches = [
    {
      ...
      link: "https://github.com/AbdelKD94/Cloud-Veille"  // Ajout de la propriété link
    }
  ];
          ...
          >
            ...
            <div className="p-6 border-t border-gray-800 bg-gray-900/50">
              <div className="flex justify-center space-x-6">
                ...
                <Link to="/Contact.tsx" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 transform hover:scale-110">
